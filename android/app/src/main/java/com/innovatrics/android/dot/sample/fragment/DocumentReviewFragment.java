...
import com.innovatrics.android.dot.sample.utils.DotUtils;
...
public abstract class DocumentReviewFragment extends Fragment {
    ...
    private void showDocumentImageDetailOverlayView(final RectF normRect) {
        ...
        final float warningCircleImageViewOffset = DotUtils.toPixels(getContext(), 13, TypedValue.COMPLEX_UNIT_DIP);
