...
public class OnboardingDocumentErrorDialogFragment extends DialogFragment {

    public static final String TAG = OnboardingDocumentErrorDialogFragment.class.getSimpleName();
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(R.string.button_try_again, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, final int which) {
                        onboardingModel.prepareDocumentCapture();
                    }
